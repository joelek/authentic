...
exports.UnknownState = autoguard.guards.Object.of({
    "type": autoguard.guards.StringLiteral.of("UNKNOWN_STATE"),
    "reason": autoguard.guards.StringLiteral.of("STATE_NOT_READ")
}, {});
exports.State = autoguard.guards.Union.of(autoguard.guards.Reference.of(() => exports.WaitingForCommandState), autoguard.guards.Reference.of(() => exports.UnknownState), autoguard.guards.Reference.of(() => exports.RegisterStates), autoguard.guards.Reference.of(() => exports.AuthenticateStates), autoguard.guards.Reference.of(() => exports.RecoverStates));
var Autoguard;
(function (Autoguard) {
    Autoguard.Guards = {
        ...
        "UnknownState": autoguard.guards.Reference.of(() => exports.UnknownState),
