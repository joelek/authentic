...
exports.WaitingForRecoverUsernameStep = void 0;
...
function WaitingForRecoverUsernameStep(managers, attributes) {
    let state = managers.backend.getState();
    let { type, reason } = state.compute((state) => api.WaitingForRecoverUsernameState.is(state) ? state : { type: undefined, reason: undefined });
...
exports.WaitingForRecoverUsernameStep = WaitingForRecoverUsernameStep;
;
