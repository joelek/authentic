...
export declare function FormButton(managers: Managers, { enabled: $enabled, primary: $primary, ...augmentations }: FormButton, ...children: Children): import("@joelek/bonsai").FunctionalElement<HTMLElementEventMap, HTMLButtonElement>;
